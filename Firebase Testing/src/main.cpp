...
#define WIFI_SSID "Ok"
#define WIFI_PASSWORD "ubaid.99"

// For the following credentials, see examples/Authentications/SignInAsUser/EmailPassword/EmailPassword.ino

/* 2. Define the API Key */
#define API_KEY "AIzaSyDMT6y3fgVJrEVdDCBiD5sLebXeRO537cM"

/* 3. Define the RTDB URL */
#define DATABASE_URL "esp32-firebase-demo-9463f-default-rtdb.firebaseio.com" //<databaseName>.firebaseio.com or <databaseName>.<region>.firebasedatabase.app

/* 4. Define the user Email and password that alreadey registerd or added in your project */
#define USER_EMAIL "amad619@gmail.com"
#define USER_PASSWORD "foolboy"
